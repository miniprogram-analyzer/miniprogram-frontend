function AppendUserMenuHtml() {
    ...
    const verification_pages = ["/m/asking", "/mobile/asking.html"]
        ...
        $.ajax({
            ...
            success: function (res) {
                if(res.successFlag == "Y"){
                    $(".user-menu .user-head .user-info .user-nick").text(username + ' ' + identity)
                    $(".user-menu .user-head .user-info p").html(user_id)
