...
var Pagination = /** @class */ (function () {
  ...
  Pagination.prototype.render = function () {
    ...
    if (this.options.type <= 1) {
      this.home = this.createElement('li', __spreadArrays(['_home'], prev_disabled, ['fal', 'fa-chevron-double-left', 'fa-fw']));
      this.home.innerText = '';
    ...
    // 上一页
    this.prev = this.createElement('li', __spreadArrays(['_prev_'], prev_disabled, ['_prev', 'fal', 'fa-chevron-left', 'fa-fw']));
    // 上一页文字
    ...
    // 下一页
    this.next = this.createElement('li', __spreadArrays(['_next_'], next_disabled, ['_next', 'fal', 'fa-chevron-right', 'fa-fw']));
    // 下一页文字
    ...
    // 尾页
    if (this.options.type <= 1) {
      this.last = this.createElement('li', __spreadArrays(['_last'], next_disabled, ['fal', 'fa-chevron-double-right', 'fa-fw']));
      this.last.innerText = '';
