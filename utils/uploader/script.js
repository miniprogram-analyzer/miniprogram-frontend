function load_uploader() { // Drop Images only
      ...
      if (file.type === 'application/x-zip-compressed') {
        ...
        reader.onload = function (e) {
          ...
          if (list.find('li').length < 5) {
            uploadHandler(file, list.find('li').length)
            li.appendTo(list);
          }
        ...
        dropContainer.addClass('dragged showDrops')
