                        ...
                        success: function (result) {
                            if(result.successFlag === "Y"&&result.msg.length>0){
                                ...
                                for (var i=0;i<result.msg.length;i++){
                                    console.log("0",result.msg[i].guestid)
                                    console.log("1",guestid)
                                    console.log("2",result.msg[i].guestid === guestid)
                                    console.log("3",result.msg[i].guestid == guestid)
                                    comment += '<li class="commt_entry"><div class="comm_con"><a><div class="t_head"></div></a><div class="level">2020</div>'
            ...
            $.ajax({
                ...
                success: function (res) {
                    if(res.successFlag === "Y"){
                        ...
                        var comment = '<li class="commt_entry"><div class="comm_con"><a><div class="t_head"></div></a><div class="level">2020</div>'
                        comment += '<div class="u_info"><div class="fl"><a class="nickname">'
