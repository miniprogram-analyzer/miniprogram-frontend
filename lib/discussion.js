...
var user_id2 = window.localStorage.getItem("user_id")
if (user_id2 !== undefined && user_id2 !== null && user_id2 !== '') {
    $.ajax({
        type: 'POST',
            ...
            $.ajax({
                ...
                success: function (res) {
                    if(res.successFlag === "Y"){
                        ...
                        comment += '<div class="u_info"><div class="fl"><a class="nickname">'
                        comment += window.localStorage.getItem("user_id")
                        comment += '</a>' + (window.localStorage.getItem("user_id") === guestid ? '<span class="mf">发帖人</span>' : '')
                        comment += '<span class="floor">'
