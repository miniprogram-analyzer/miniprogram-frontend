  ...
  $.ajax({
    ...
    success: function (res) {
      if (res.successFlag == "Y") {
        ...
        toplogin_script = "<a href=\"javascript:;\" class=\"item-link\" id=\"rm_avatar\">" + (avatar_img == "/" ? "<div></div>" : "<img src=\"" + avatar_img + "\" />") + username + "</a><div id=\"avatar\" class=\"menu\"><ul><li><a href=\"/user\" target=\"_blank\">个人中心</a> &nbsp;|&nbsp; <a href=\"/user#modify\" target=\"_blank\">修改资料</a></li><li class=\"line\"></li><li style=\"text-align:center;\"><a id=\"btnLogout\" href=\"javascript:;\">退出登录</a></li></ul></div>"
        topcallback(toplogin_script);
        if (location.pathname == "/" || location.pathname == "/index.html") {
