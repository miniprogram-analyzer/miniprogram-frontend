...
const verification_pages = ["/asking", "/pages/asking.html", "/analysing", "/pages/analysing.html", "/code_detail", "/pages/code_detail.html"]
    ...
    $.ajax({
        ...
        success: function (res) {
            if(res.successFlag == "Y"){
                ...
                toplogin_script = "<a href=\"javascript:;\" class=\"item-link\" id=\"rm_avatar\">" + (avatar_img == "/" ? "<div></div>" : "<img src=\"" + avatar_img + "\" />") + username + "</a><div id=\"avatar\" class=\"menu\"><ul><li><a href=\"/pages/user.html\" target=\"_blank\">个人中心</a> &nbsp;|&nbsp; <a href=\"/pages/user.html\" target=\"_blank\">修改资料</a></li><li class=\"line\"></li><li style=\"text-align:center;\"><a id=\"btnLogout\" href=\"javascript:;\">退出登录</a></li></ul></div>"
                topcallback(toplogin_script);
                if(location.pathname == "/" || location.pathname == "/index.html"){
                    rightlogin_script = "<div class=\"info-row\"><div id=\"avatar\">" + (avatar_img == "/" ? "" :"<img src=\"" + avatar_img + "\" />" ) + "</div><div id=\"username\"><a href=\"/pages/user.html\" target=\"_blank\" class=\"realname title\">" + username + "&nbsp;" + identity + "</a><a href=\"/pages/user.html\" target=\"_blank\" class=\"id\">" + user_id + "</a></div></div>"
