    ...
    $.ajax({
        ...
        success: function (res) {
            if(res.successFlag == "Y"){
                ...
                topcallback(toplogin_script);
                if(location.pathname == "/" || location.pathname == "/index.html"){
                    rightlogin_script = "<div class=\"info-row\"><div id=\"avatar\">" + (avatar_img == "/" ? "" :"<img src=\"" + avatar_img + "\" />" ) + "</div><div id=\"username\"><a href=\"/pages/user.html\" target=\"_blank\" class=\"realname title\">" + username + "&nbsp;" + identity + "</a><a href=\"/pages/user.html\" target=\"_blank\" class=\"id\">" + id + "</a></div></div>"
