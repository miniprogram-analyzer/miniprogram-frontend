...
const verification_pages = ["/asking/", "/pages/asking.html"]
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            if(location.pathname == "/" || location.pathname == "/index.html"){
                rightlogin_script = "<div class=\"info-row\"><div id=\"avatar\"></div><div id=\"username\"><a href=\"/pages/user.html\" target=\"_blank\" class=\"realname title\">" + username + "&nbsp;" + identity + "</a><a href=\"/pages/user.html\" target=\"_blank\" class=\"id\">" + id + "</a></div></div>"
        ...
        error: function (err) {
            ...
            if(verification_pages.includes(location.pathname) && document.querySelector("div#mask") === null){
                var titleLogin = '<span class="active" onclick="$(this).addClass(\'active\').siblings().removeClass(\'active\');$(\'#maskTop iframe\').attr(\'src\',\'/login/' + (nightMode ? '?night=1' : "") + '\');">登录</span><span onclick="$(this).addClass(\'active\').siblings().removeClass(\'active\');$(\'#maskTop iframe\').attr(\'src\',\'/pages/vue_register.html' + (nightMode ? '?night=1' : "") + '\')">注册</span>';
...
$('body').on("click", ".register",
    function () {
        if (document.querySelector("div#mask") === null) {
            var titleLogin = '<span onclick="$(this).addClass(\'active\').siblings().removeClass(\'active\');$(\'#maskTop iframe\').attr(\'src\',\'/login/' + (nightMode ? '?night=1' : "") + '\');">登录</span><span class="active" onclick="$(this).addClass(\'active\').siblings().removeClass(\'active\');$(\'#maskTop iframe\').attr(\'src\',\'/pages/vue_register.html' + (nightMode ? '?night=1' : "") + '\')">注册</span>';
