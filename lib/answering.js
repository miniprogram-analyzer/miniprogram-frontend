    ...
    success: function (res) {
        //if(res.successFlag === "Y"){
            new Pagination({
                ...
                pageCount: location.pathname != '/answering' ? 5 : 7,
                total: 100,//res.length,
                jumper: true,
